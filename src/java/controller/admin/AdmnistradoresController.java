...
@WebServlet(name = "FuncionariosController", urlPatterns = {"/admin/FuncionariosController"})
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (acao) {
            case "ListarFuncionario":
                ...
                rd = request.getRequestDispatcher("/views/admin/funcionarios/listaFuncionario.jsp");
            ...
            case "Alterar":
                ...
                rd = request.getRequestDispatcher("/views/admin/funcionarios/updateFuncionario.jsp");
                rd.forward(request, response);
                break;
            ...
            case "Excluir":
                ...
                rd = request.getRequestDispatcher("/views/admin/funcionarios/excluirFuncionario.jsp");
                rd.forward(request, response);
                break;
            case "Incluir":
                request.setAttribute("funcionarios", funcionarios);
                ...
                rd = request.getRequestDispatcher("/views/admin/funcionarios/cadastraFuncionario.jsp");
                rd.forward(request, response);
        }
